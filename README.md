...
本 MOD 允许他人免费、非商业地搬运、转载、镜像和提供原始完整发布包下载，也允许将未作任何修改的
原始 Mod 文件纳入免费整合包或安装器中再分发。搬运时必须保留原作者“`NoWindNoMoon / 此情无关风月`”、
原项目名称、许可证、来源链接、第三方权利声明和非官方项目说明，并保持项目原创 Mod 内容和文件组成完整。
禁止修改、替换、移除或拆分 Mod 后发布；GitHub Fork 不等于取得修改后发布的许可。出售、收费下载、付费
访问以及广告、赞助、捐赠门槛等任何变相收费均绝对禁止。
